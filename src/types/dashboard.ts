...
export interface BinanceFuturesEntryConditions {
  '1m_golden_cross': boolean;
  '5m_above': boolean;
  '15m_above': boolean;
  '15m_ema38_above': boolean;
...
export interface BinanceFuturesShortConditions {
  '1m_dead_cross': boolean;
  '5m_below': boolean;
  '15m_below': boolean;
...
export interface BinanceFuturesTimeframeIndicators {
  ema_short: number;
  ema_long: number;
  above: boolean;
  golden_cross: boolean;
...
export interface BinanceFutures15mIndicators extends BinanceFuturesTimeframeIndicators {
  ema3: number;
  ema8: number;
  ema3_8_above: boolean;
}

export interface BinanceFuturesIndicators {
  '1m': BinanceFuturesTimeframeIndicators;
  '5m': BinanceFuturesTimeframeIndicators;
  '15m': BinanceFutures15mIndicators;
  '30m': BinanceFuturesTimeframeIndicators;
  '1h': BinanceFuturesTimeframeIndicators;
  '4h': BinanceFuturesTimeframeIndicators;
  '1d': BinanceFuturesTimeframeIndicators;
  market_regime: 'U' | 'S' | 'D';
  trend_health_score: number;
}

export interface BinanceFuturesStrategy {
  version: string;
  entryConditionsLong: BinanceFuturesEntryConditions;
  entryConditionsShort: BinanceFuturesShortConditions;
  indicators: BinanceFuturesIndicators;
  pp_reversal_price: number | null;
}
...
export interface BinanceFuturesTrade {
  ...
  quantity: number;
  pnlPercent: number;
  reason: 'PP' | 'SL' | 'EARLY' | 'VANISH' | 'TIMEOUT';
  holdSeconds: number;
}

export interface BinanceFuturesDashboardData {
  currentPrice: number;
  serverTime: number;
  wsHealthy: boolean;
  exchange: string;
  ...
  strategy: BinanceFuturesStrategy;
  metrics: BinanceFuturesMetrics;
  trades: BinanceFuturesTrade[];
  priceHistory1m?: Candle[];
  priceHistory5m?: Candle[];
  priceHistory15m?: Candle[];
  priceHistory30m?: Candle[];
