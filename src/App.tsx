    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-amber-50">
      ...
      <div className="max-w-[98vw] mx-auto p-2 lg:p-4">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-[280px,1fr,280px] gap-2" style={{ alignItems: 'start' }}>
          <div className="flex flex-col gap-2 order-2 lg:order-1" style={{ height: '690px' }}>
            <MetricsPanel
          ...
          <div className="order-3 lg:order-3" style={{ width: '280px', height: '690px', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
