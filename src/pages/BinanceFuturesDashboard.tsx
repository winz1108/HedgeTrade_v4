...
function BinanceFuturesDashboard() {
        ...
        <div className="flex flex-col mb-2 bg-white/80 border border-amber-200 rounded-lg p-3 shadow-xl gap-3">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-3 ml-auto">
              <span className="text-xs text-stone-600 font-bold">Jihun</span>
              <span className="text-xs text-stone-400">•</span>
              <span className="text-xs text-orange-600 font-bold">BTC/USD</span>
              {data.serverTime && (
                <>
                  <span className="text-xs text-stone-400">•</span>
...
export default BinanceFuturesDashboard;
