        ...
        <div className="bg-white/95 border border-slate-200 rounded-lg shadow-sm p-2">
          ...
          <div className="space-y-1.5">
            <div className="bg-amber-50 rounded-lg p-2 border border-amber-200">
              <div className="text-[9px] text-amber-800 font-medium mb-0.5">TOTAL ASSET</div>
              <div className="text-xl font-bold text-slate-900 mb-1">
                {formatCurrency(data.currentAsset)}
              </div>
              <div className="space-y-0.5 pt-1 border-t border-amber-200">
                <div className="flex justify-between items-center">
                  <span className="text-[8px] text-slate-600">BTC</span>
                  <span className="text-[10px] font-bold text-amber-700">
                    {formatCurrency(data.currentBTC || 0)}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[8px] text-slate-600">USDC</span>
            ...
            <div className="border-t border-slate-200 pt-1.5">
              <div className="text-[9px] text-slate-700 mb-1 font-medium">POSITION</div>
              {data.holding.isHolding ? (
                <div className="space-y-0.5 bg-blue-50 rounded-lg p-1.5 border border-blue-200">
                  <div className="flex justify-between items-center">
                    <span className="text-[8px] text-slate-600">Entry</span>
                    <span className="text-[10px] font-bold text-slate-800">{formatCurrency(data.holding.buyPrice!)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[8px] text-slate-600">P&L</span>
                  ...
                  {data.holding.buyTime && (
                    <div className="flex justify-between items-center">
                      <span className="text-[8px] text-slate-600">Duration</span>
                ...
                <div className="px-2 py-1 bg-slate-100 text-slate-600 rounded text-[9px] font-bold inline-block border border-slate-200">
                  NO POSITION
                </div>
              )}
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="space-y-0.5">
                ...
                <div className="pt-0.5">
                  <div className="text-[8px] font-bold text-slate-600 mb-0.5">EMA Above</div>
                    ...
                    {MULTI_TF_CONDITIONS.map(({ key, label }) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="text-[7px] font-medium text-slate-700 mt-0.5">{label}</span>
                        </div>
                      );
                    })}
                  </div>
                ...
                <div className="pt-0.5">
                  <div className="text-[8px] font-bold text-slate-600 mb-0.5">Slope Up</div>
                ...
                <div className="pt-0.5">
                  <div className="text-[8px] font-bold text-slate-600 mb-0.5">BBW</div>
                  <div className="grid grid-cols-2 gap-0.5">
          ...
          {strategy?.sellConditions ? (
            <div className="space-y-1">
              <div className={`flex items-center justify-between px-1.5 py-1 rounded border ${
                ...
                <span className="text-[9px] font-medium text-slate-700">Dead Cross</span>
                {strategy.sellConditions.dead_cross.met ? (
              ...
              <div className="pt-0.5">
                <div className="flex items-center justify-between mb-0.5">
                  <div className="text-[8px] font-bold text-slate-600">Early Exit</div>
      ...
      <div className="bg-white/95 border border-amber-200 rounded-lg shadow-sm p-2">
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex items-center gap-1">
            <span className="text-[8px] text-slate-500 font-mono">7d</span>
                ...
                {trade.type === 'buy' ? (
                  <div className="bg-blue-50 border border-blue-300 rounded p-1">
                    <div className="flex items-center justify-between">
                      <span className="text-[9px] font-bold text-blue-600">BUY</span>
        ...
        <div className="space-y-1.5">
          {data.metrics.portfolioReturnWithCommission !== undefined && (
            <div className="bg-gradient-to-br from-emerald-100 to-teal-100 p-2 rounded-lg border border-emerald-300">
              <div className="text-[9px] text-emerald-800 font-bold mb-0.5">NET PROFIT</div>
              <div
          ...
          <div className="space-y-0.5">
            <div className="flex justify-between items-center bg-amber-50 p-1 rounded border border-amber-200">
              <span className="text-[8px] text-slate-700 font-medium">Portfolio Return</span>
              <span className={`text-[10px] font-bold ${
            ...
            <div className="flex justify-between items-center bg-amber-50 p-1 rounded border border-amber-200">
              <span className="text-[8px] text-slate-700 font-medium">Market Change</span>
              <span className={`text-[10px] font-bold ${
            ...
            <div className="flex justify-between items-center bg-amber-50 p-1 rounded border border-amber-200">
              <span className="text-[8px] text-slate-700 font-medium">Avg Trade Return</span>
              <span className={`text-[10px] font-bold ${
      ...
      <div className="bg-white/95 border border-blue-200 rounded-lg shadow-sm p-2">
        ...
        <div className="space-y-1">
          <div className="flex justify-between items-center bg-emerald-50 p-1.5 rounded border border-emerald-300">
            <span className="text-[9px] text-emerald-700 font-bold">Profit (TP)</span>
          ...
          <div className="flex justify-between items-center bg-rose-50 p-1.5 rounded border border-rose-300">
            <span className="text-[9px] text-rose-600 font-bold">Loss (SL)</span>
          ...
          {data.metrics.totalTrades !== undefined && (
            <div className="flex justify-between items-center bg-slate-50 p-1 rounded border border-slate-200">
              <span className="text-[9px] text-slate-700 font-bold">Total</span>
              <span className="text-xs font-bold text-slate-700">{data.metrics.totalTrades}</span>
            </div>
          )}
          <div className="border-t border-blue-200 pt-1 mt-1">
            <div className="text-[9px] text-slate-700 mb-1 font-bold">WIN RATE</div>
