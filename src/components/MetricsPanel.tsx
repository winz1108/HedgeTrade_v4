...
export const MetricsPanel = ({ data, position }: MetricsPanelProps) => {
      ...
      <div className="flex flex-col gap-1.5">
        <div className="bg-white border border-slate-200 rounded p-2">
          ...
          <div className="space-y-1.5">
            ...
            <div>
              <div className="text-[8px] font-medium text-slate-500 mb-1 uppercase">Position</div>
              {data.holding.isHolding ? (
                <div className="space-y-0.5 bg-blue-50/50 rounded p-1.5 border border-blue-200">
                  <div className="flex justify-between items-center">
                    <span className="text-[8px] font-medium text-slate-600">Entry</span>
                    <span className="text-[9px] font-semibold text-slate-800">{formatCurrency(data.holding.buyPrice!)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[8px] font-medium text-slate-600">P&L</span>
                  ...
                  {data.holding.buyTime && (
                    <div className="flex justify-between items-center">
                      <span className="text-[8px] font-medium text-slate-600">Duration</span>
                      <span className="text-[9px] font-semibold text-slate-700">
                ...
                <div className="px-2 py-1 bg-slate-50 text-slate-500 rounded border border-slate-200 text-[8px] font-medium text-center">
                  No Position
                </div>
              )}
            </div>
        ...
        <div className="bg-white border border-slate-200 rounded p-2">
          <div className="flex items-center justify-between mb-1.5">
            <h3 className="text-[10px] font-medium text-slate-600 uppercase">Entry</h3>
            <div className="flex items-center gap-1">
              <span className="text-[9px] text-slate-500 font-medium">{conditionsMet}/{conditionsTotal}</span>
          ...
          {strategy ? (
            <div className="space-y-1">
              ...
              <div className="grid grid-cols-2 gap-1 pt-0.5">
                <div>
                  <div className="text-[8px] font-medium text-slate-500 mb-0.5 uppercase">EMA Above</div>
                  <div className="space-y-0.5">
                    {MULTI_TF_CONDITIONS.map(({ key, label }) => {
                      ...
                      return (
                        <div
                          key={key}
                          className={`flex items-center justify-between px-1.5 py-1 rounded border text-[8px] font-medium ${
                            met
                ...
                <div>
                  <div className="text-[8px] font-medium text-slate-500 mb-0.5 uppercase">BBW</div>
                  <div className="space-y-0.5">
              ...
              <div className="pt-0.5">
                <div className="text-[8px] font-medium text-slate-500 mb-0.5 uppercase">Slope Up</div>
            ...
            <div className="flex items-center justify-center h-10 text-slate-400 text-[9px]">
              Waiting...
            </div>
          )}
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded p-2">
          <div className="flex items-center justify-between mb-1.5">
            <h3 className="text-[10px] font-medium text-slate-600 uppercase">Exit</h3>
            {strategy?.sellConditions?.any_sell && (
              <div className="flex items-center gap-1">
                <span className="text-[8px] font-medium text-red-600">ACTIVE</span>
          ...
          {strategy?.sellConditions ? (
            <div className="space-y-1">
                  ...
                  <div className="px-2 py-1.5">
                    <div className="flex items-center justify-between mb-1">
                      <div className="flex items-center gap-1">
                        ...
                        {strategy.sellConditions.smart_trail.active && (
                          <span className="text-[7px] font-medium px-1 py-0.5 rounded bg-orange-100 text-orange-700">ACT</span>
                        )}
                      </div>
                      <div className={`w-1 h-1 rounded-full ${
                    ...
                    <div className="grid grid-cols-2 gap-1 mb-1">
                      <div className={`rounded border p-1 ${
                        ...
                        <div className="text-[7px] font-medium text-slate-500 mb-0.5">EMA3</div>
                        <div className="font-mono text-[8px] font-medium text-slate-700">
                      ...
                      <div className={`rounded border p-1 ${
                        ...
                        <div className="text-[7px] font-medium text-slate-500 mb-0.5">EMA8</div>
                        <div className="font-mono text-[8px] font-medium text-slate-700">
                    ...
                    <div className={`rounded border px-1.5 py-0.5 mb-1 ${
                      strategy.sellConditions.smart_trail['15m_above']
                        ? 'bg-slate-50 border-slate-200'
                        : 'bg-red-50 border-red-200'
                    }`}>
                      <div className="flex items-center justify-between">
                        <span className="text-[8px] font-medium text-slate-600">Status</span>
                      ...
                      <div className="bg-slate-50 border border-slate-200 rounded p-1 space-y-0.5">
                        ...
                        <div className="flex justify-between text-[8px]">
                          ...
                          <div className="flex items-center gap-0.5">
                            ...
                            <span className="text-[7px] font-medium px-1 py-0.5 rounded bg-blue-100 text-blue-700">
                    ...
                    <div className="mt-1 pt-1 border-t border-slate-200">
                      <div className="flex items-center justify-between text-[7px]">
                        ...
                        <span className="font-medium px-1 py-0.5 rounded bg-slate-200 text-slate-700">
              ...
              <div className={`flex items-center justify-between px-2 py-1 rounded border ${
                ...
                <span className="text-[9px] font-medium">1h Dead Cross</span>
                <div className={`w-1 h-1 rounded-full ${
    ...
    return (
      <div className="bg-white border border-slate-200 rounded p-2">
        <div className="flex items-center justify-between mb-1.5">
          ...
          <div className="flex items-center gap-1">
            <span className="text-[8px] font-medium text-slate-500">7d</span>
            <History className="w-2.5 h-2.5 text-slate-400" />
          </div>
        </div>

        <div className="space-y-0.5 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent" style={{ maxHeight: '140px' }}>
          {recentTrades.length > 0 ? (
            recentTrades.map((trade, index) => (
              <div key={`${trade.timestamp}-${index}`}>
                {trade.type === 'buy' ? (
                  <div className="bg-blue-50/50 border border-blue-200 rounded p-1">
                    <div className="flex items-center justify-between">
                      <span className="text-[8px] font-medium text-blue-600">BUY</span>
                      <div className="flex flex-col items-end">
                        <span className="text-[9px] font-semibold text-slate-700">{formatCurrency(trade.price)}</span>
                  ...
                  <div className={`${getExitReasonColor(trade.exitReason).bg} ${getExitReasonColor(trade.exitReason).border} border rounded p-1`}>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-0.5">
                        <span className={`text-[8px] font-medium ${getExitReasonColor(trade.exitReason).text}`}>SELL</span>
                        {trade.exitReason && (
  ...
  return (
    <div className="flex flex-col gap-1.5">
        ...
        <div className="space-y-1.5">
          {data.metrics.portfolioReturnWithCommission !== undefined && (
            <div className="bg-slate-50 p-1.5 rounded border border-slate-200">
              <div className="text-[8px] font-medium text-slate-500 mb-0.5 uppercase">Net Profit</div>
              <div
          ...
          <div className="space-y-0.5">
            <div className="flex justify-between items-center bg-slate-50 p-1 rounded border border-slate-200">
              <span className="text-[8px] font-medium text-slate-600">Portfolio Return</span>
            ...
            <div className="flex justify-between items-center bg-slate-50 p-1 rounded border border-slate-200">
              <span className="text-[8px] font-medium text-slate-600">Market Change</span>
              <span className={`text-[9px] font-semibold ${
            ...
            <div className="flex justify-between items-center bg-slate-50 p-1 rounded border border-slate-200">
              <span className="text-[8px] font-medium text-slate-600">Avg Trade Return</span>
              <span className={`text-[9px] font-semibold ${
      ...
      <div className="bg-white border border-slate-200 rounded p-2">
        <div className="flex items-center justify-between mb-1.5">
          <h3 className="text-[10px] font-medium text-slate-600 uppercase">Statistics</h3>
          <Target className="w-3 h-3 text-slate-400" />
        </div>

        <div className="space-y-1">
          <div className="flex justify-between items-center bg-green-50/50 p-1.5 rounded border border-green-200">
            <span className="text-[8px] font-medium text-green-700">Profit (TP)</span>
            <span className="text-sm font-semibold text-green-600">{data.metrics.takeProfitCount}</span>
          </div>
          <div className="flex justify-between items-center bg-red-50/50 p-1.5 rounded border border-red-200">
            <span className="text-[8px] font-medium text-red-700">Loss (SL)</span>
            <span className="text-sm font-semibold text-red-600">{data.metrics.stopLossCount}</span>
          </div>
          {data.metrics.totalTrades !== undefined && (
            <div className="flex justify-between items-center bg-slate-50 p-1 rounded border border-slate-200">
              <span className="text-[8px] font-medium text-slate-600">Total</span>
          ...
          <div className="border-t border-slate-200 pt-1 mt-1">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-semibold text-slate-700 min-w-[38px]">
                {winRate.toFixed(1)}%
              </span>
            </div>
          </div>
