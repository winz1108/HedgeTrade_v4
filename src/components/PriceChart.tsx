                  ...
                  >
                    {trade.type === 'buy' ? (
                      <div className="relative flex items-center justify-center">
                        ...
                        } ${isHovered ? 'scale-125' : ''} ${trade.isPaired ? '' : trade.side === 'SHORT' ? 'bg-slate-200' : 'bg-cyan-500'}`}>
                          <div className="w-full h-full flex items-center justify-center">
                            <span className={`${trade.isPaired ? (trade.side === 'SHORT' ? 'text-orange-600' : 'text-cyan-500') : trade.side === 'SHORT' ? 'text-orange-600' : 'text-white'} text-xs font-bold`}>{trade.side === 'SHORT' ? 'S' : 'L'}</span>
                          </div>
                        </div>
                      </div>
                    ) : (() => {
