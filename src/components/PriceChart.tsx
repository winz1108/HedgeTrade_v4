...
import { DashboardData, TradeEvent, Candle, V10StrategyStatus, ZoneData, BosLevel } from '../types/dashboard';
    ...
    <div className={`${colors.chartBg} rounded-xl shadow-lg border ${colors.chartBorder} w-full overflow-hidden ${isMaximized ? 'fixed inset-0 z-50 h-screen rounded-none' : ''}`}>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-visible">
          {/* 호버 툴팁: 호버 시에만 표시 (price area only) */}
          <div className={`absolute left-3 top-3 z-30 flex flex-col gap-1 pointer-events-none`}>
            {hoveredCandle && (crosshairPosition?.y ?? 0) < (priceChartHeight + volumeChartHeight + macdChartHeight + 44) && (() => {
          ...
          >
            ...
            {showTradeMarkers && !['30m', '1h', '4h', '1d'].includes(timeframe) && (() => {
